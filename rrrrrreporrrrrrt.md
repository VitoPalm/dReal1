...
## 0.1. Import del Dataset
<!--- You know the drill ---> 
Per prima cosa è stato importato il dataset in esame (`read.csv()`).
...
- dati di tipo quantitativo continuo
- obiettivi svolgimento analisi descrittiva

## 1.1. Visualizzazione dei Dati agli Estremi della Variabile Dipendente
- Useless
